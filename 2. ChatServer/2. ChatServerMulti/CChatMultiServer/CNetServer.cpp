...
void CNetServer::InitServer(const WCHAR* ServerIP, short ServerPort, int Nagle, bool ZeroCopy, int iWorker, int iActive, int MaxSession, DWORD dwLoginTimeOut, DWORD dwReserveDisconnect, bool bCheckTimeOut, bool bReserveDisconnect)
{
...
bool CNetServer::StartServer(void)
{
...
void CNetServer::StopServer(void)
{
...
void CNetServer::InitVariable(void)
{
...
void CNetServer::InitSession(void)
{
...
void CNetServer::InitNetwork(void)
{
	linger lin = { 1,0 };
	int iSendBuf = 0;
...
void CNetServer::InitThread(void)
{
...
bool CNetServer::SetTimeOut(SESSION_ID iSessionID, DWORD dwTime)
{
	CSession* pSession;
...
bool CNetServer::Disconnect(SESSION_ID iSessionID, short shType)
{
	CSession* pSession;
	pSession = FindSession(iSessionID);
...
bool CNetServer::SendPacket(SESSION_ID iSessionID, CPacket* pPacket, bool bReserveRelease)
{
	CSession* pSession;
...
bool CNetServer::SendPackets(SESSION_ID iSessionID, CPacket** pPacketArr, int iCount, bool bReserveRelease)
{
	CSession* pSession;
	CPacket* pPacket;
...
bool CNetServer::SendPacketInstant(SESSION_ID iSessionID, CPacket* pPacket, bool bReserveRelease)
{
	CSession* pSession;
...
CSession* CNetServer::SetSession(SOCKET ClientSock, SOCKADDR_IN* ClientAddr)
{
	CSession* pSession;
	int        iSessionIdx;
...
unsigned CNetServer::AcceptThread(void* lpParam)
{
	SOCKET      ClientSock;
...
unsigned CNetServer::WorkerThread(void* lpParam)
{
	bool          ret;
	DWORD         cbTransferred;
	CSession*     pSession;
...
unsigned CNetServer::CheckDisconnectThread(void* lpParam)
{
...
void CNetServer::RecvProc(CSession* pSession, DWORD cbTransferred)
{
...
void CNetServer::RecvPacket(CSession* pSession)
{
	CPacket* pPacket;
...
bool CNetServer::CheckPacket(CSession* pSession, CPacket* pPacket)
{
	stNetHeader* Header;
...
void CNetServer::SendProc(CSession* pSession, DWORD cbTransferred)
{
	int iSendPacket;
...
unsigned CNetServer::MonitoringThread(void* lpParam)
{
	bool  bControl = FALSE;
	CFrame Frame(1000);
