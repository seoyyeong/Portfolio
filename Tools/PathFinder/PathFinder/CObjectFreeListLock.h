...
public : 
	...
	CObjectFreeList(int iAllocSize = 1000, char chPlacementNew = false)
	{
		Node* pPrev;
		Node* pNode;
		T* pData;
	...
	T* Alloc(void)
	{
		...
		if (_size == _useSize) //다써서 처음부터 재할당
		{
	...
	void GarbageCollect(void)///////////////////////////////수정필요
	{
		//80퍼센트정도보다 많이 남았으면,,, free해주기.
	}
